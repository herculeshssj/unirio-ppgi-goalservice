 ...
 */
package ie.deri.wsmx.servicediscovery.dummy;
...
public class DummyDiscovery {
	...
	String[][] pairs = { {"http://deri.org/dip/goal/demoVTA1#GoalMediateTime1","http://deri.org/demoVTA/WSMediateTime"},
						 ...
						 {"http://www.example.org/TestCreateBothGoal_UoM","http://swing.brgm.fr/repository/compositionfiles/DEVmanual-UC1-ASM-FTO/current#ConsumptionProductionMap"},
...
//			System.out.println(pairs[i][0]+ " -  - " +pairs[i][1]);
    ...
    public static void main(String[] args){
    	DummyDiscovery d = new DummyDiscovery();
    }
    
	public List<WebService> discover(Goal goal, List<WebService> webServices) throws ComponentException, UnsupportedOperationException {
    ...
    private static List<WebService> retrieveWebService(List<Identifier> identifiers, List<WebService> webServices) 
    {
    	...
    	logger.error("Identifiers space: ");
        ...
        {
        	logger.error("WS identifiers: "+ws.getIdentifier());
        	for (Identifier i : identifiers){
