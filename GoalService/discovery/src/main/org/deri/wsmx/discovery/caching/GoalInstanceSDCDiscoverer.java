 ...
 *
 * @version $Revision: 1.4 $ $Date: 2007-10-09 14:47:26 $
 */ 
...
public class GoalInstanceSDCDiscoverer {
	...
	public Instance goalTemplateSearch (Instance goalInstance, Ontology sdcGraph) {
		...
		for (Goal childOfCurrentGT : helper.getAllChildNodes(theCurrentGT, sdcGraph)) {
