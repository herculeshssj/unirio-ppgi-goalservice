...
public class SDCNaiveComparisonAllWS {
	
	protected static Logger logger;
	
	private SDCRuntimeDiscoverer sdcDiscoverer; 
	...
	public SDCNaiveComparisonAllWS() {
		sdcDiscoverer = new SDCRuntimeDiscoverer();
		...
		logger = Logger.getLogger(SDCNaiveComparisonAllWS.class);
