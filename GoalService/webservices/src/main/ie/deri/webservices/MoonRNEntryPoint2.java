...
public class MoonRNEntryPoint2 {
...
// * * $Source: /cygdrive/e/progs/cygwin/usr/maczar/cvsbackup/webservices/src/main/ie/deri/webservices/MoonRNEntryPoint2.java,v $, * @version $Revision: 1.3 $ $Date: 2007-10-11 14:53:38 $
// */
//public class MoonRNEntryPoint2 {
//
//	protected static Logger logger = Logger.getLogger(MoonRNEntryPoint2.class);
//	
//	static {
...
//	}
//	
//    public Element[] receivePO2(Element [] elems) {
//    	
...
//					
//					xsltPath = "resources"+File.separator+"communicationmanager"+File.separator+"por2poc2.xsl";
...
//    	String xmlPORAcknPath = "resources"+File.separator+"webservices"+File.separator+"templates"+File.separator+"Ack_POR2.xml"; 
...
//			String xsltPath = "resources"+File.separator+"communicationmanager"+File.separator+"po2WSML3_NoNamespaceDef2.xsl";
//			File xsltFile = new File(Environment.getKernelLocation() + File.separator + xsltPath);
//			String translatedXML = doTransformation(sw.toString(), new FileInputStream(xsltFile));
//			
//			//read Goal definition
//	    	String tempPath = "resources"+File.separator+"resourcemanager"+File.separator+"goals"+File.separator+"MoonGoal2.wsml";
...
//	    		}
//	    		
//	    		//serialize Goal Ontology
//				StringBuffer sb = new StringBuffer();
//				Serializer wsmlSerializer = new SerializerImpl(new HashMap());
//				wsmlSerializer.serialize(new TopEntity[]{goalOnto}, sb);
//				String finalRespStr = sb.toString();
//				logger.debug("Goal ontology------:" + finalRespStr +"-------");
//  		
//	    		
//	    		
//	    		
...
//    }
//    
//    public class LineOrderConfimation {
//    	
//    	private int orderId;
...
//    	try {
////    		Parser parser = Factory.createParser(new HashMap<String, Object>());
////    		@SuppressWarnings("unused") TopEntity[] te2 = parser.parse(new FileReader("resources"+File.separator+"resourcemanager"+File.separator+"ontologies"+File.separator+"temp.wsml"));
//    		
//			MoonRNEntryPoint2 mRNE = new MoonRNEntryPoint2();
//			
//			String tempPath = "resources"+File.separator+"resourcemanager"+File.separator+"goals"+File.separator+"MoonGoal.wsml";
//			Reader reader = new InputStreamReader(ClassLoader.getSystemResourceAsStream(tempPath));
//			BufferedReader br = new BufferedReader(reader);
//
//			String record = null, wsmlString = "";
//			while ((record = br.readLine()) != null)
//				wsmlString += record + "\n";
//			
//			//read PO
//	    	String xmlPORPath = "resources"+File.separator+"webservices"+File.separator+"Example_Purchase_Order_Request.xml"; 
//	    	//File xmlPOR = new File(Environment.getKernelLocation() + "/" + xmlPORPath);
//			
//			try {
//				DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
//				DocumentBuilder builder = factory.newDocumentBuilder();
//				
//				// Parse the document		
//				Document documentPOR = builder.parse(xmlPORPath);
//
//				Element rootPOR = documentPOR.getDocumentElement();
//
//				mRNE.new AsynchronousInvoker(wsmlString,rootPOR,null, null);
//			} catch (Exception e){
//				e.printStackTrace();
//			}
//
