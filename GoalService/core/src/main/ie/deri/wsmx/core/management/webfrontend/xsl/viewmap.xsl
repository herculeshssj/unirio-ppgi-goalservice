...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:param name="head.title">WSMX - Map View</xsl:param>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
               ...
               <tr>
                  <td colspan="4" class="fronttab">
                    Map of class <xsl:value-of select="MBean/Attribute/@classname"/>
                     on attributes <xsl:value-of select="MBean/Attribute/@name"/>
                  </td>
               </tr>
               <tr>
                  <td class="fronttab">
