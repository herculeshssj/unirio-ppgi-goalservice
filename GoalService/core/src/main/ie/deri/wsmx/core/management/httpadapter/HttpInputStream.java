 ...
 * $$Source: /cygdrive/e/progs/cygwin/usr/maczar/cvsbackup/core/src/main/ie/deri/wsmx/core/management/httpadapter/HttpInputStream.java,v $$
 * </pre>
 * 
 * @author Thomas Haselwanter
 * @author Michal Zaremba
 *
 * @version $Revision: 1.6 $ $Date: 2005-08-14 04:30:58 $
 */ 
public class HttpInputStream extends BufferedInputStream {
    ...
    public void readRequest() throws IOException  {
        ...
        if (request == null) {
            throw new HttpException(HttpConstants.STATUS_BAD_REQUEST,
                    "Null query");
        }
        // Parses the request
     ...
     * @return A read line
     * @throws IOException
     *             Emmited in case of errors reading the stream
     */
     ...
     * 
     * @return A map containing variables/value pairs. If a variable is <p/>
     *         present only once in the request the value will be a String. <p/>
    ...
    /**
     * Returns one variable value. If the variable is present many times, the
     * first <p/>instance will be returned
     * 
        ...
        try {
            ...
            if (method.equals(HttpConstants.METHOD_POST)
                ...
                if ("chunked".equals(headers.get("transfer-encoding"))) {
                    throw new HttpException(HttpConstants.STATUS_BAD_REQUEST,
                            "Sorry I don't understand chunked requests");
                }
            ...
            while (parser.hasMoreTokens()) {
                ...
                if (equalIndex > 0) {
                    String variableName = URLDecoder.decode(command.substring(
                            0, equalIndex), "UTF-8");
