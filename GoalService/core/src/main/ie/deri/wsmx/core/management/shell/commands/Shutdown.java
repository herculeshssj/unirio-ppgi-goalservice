 ...
 * $$Source: /cygdrive/e/progs/cygwin/usr/maczar/cvsbackup/core/src/main/ie/deri/wsmx/core/management/shell/commands/Shutdown.java,v $$
 * </pre>
 * 
 ...
 */ 
public class Shutdown extends InvokeOperationCommandProcessor 
	...
	public void printHelpText(ie.deri.wsmx.core.management.sshadapter.TerminalIO terminal, int baseColor, int highlightColor) throws IOException {
		...
		terminal.write("d");
		terminal.setForegroundColor(baseColor);
		terminal.write("own\tInitiates the shutdown sequence.");
		terminal.flush();		
	}

	public void printUsageText(ie.deri.wsmx.core.management.sshadapter.TerminalIO terminal, int baseColor, int highlightColor) throws IOException {
		terminal.setForegroundColor(baseColor);
    ...
    public void execute(AdministrativeShell shell, List<String> arguments)
        ...
        terminal.println("System is shutting down NOW.");
        execute();
    }
