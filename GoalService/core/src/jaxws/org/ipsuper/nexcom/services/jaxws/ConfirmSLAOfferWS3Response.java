...
@XmlRootElement(name = "confirmSLAOfferWS3Response", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "confirmSLAOfferWS3Response", namespace = "http://ip-super.org/usecase/nexcom/")
public class ConfirmSLAOfferWS3Response {
