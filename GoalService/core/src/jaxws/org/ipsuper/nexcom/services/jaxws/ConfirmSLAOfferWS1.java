...
@XmlRootElement(name = "confirmSLAOfferWS1", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "confirmSLAOfferWS1", namespace = "http://ip-super.org/usecase/nexcom/")
public class ConfirmSLAOfferWS1 {
