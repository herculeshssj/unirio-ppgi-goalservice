...
@XmlRootElement(name = "confirmSLAOfferWS4", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "confirmSLAOfferWS4", namespace = "http://ip-super.org/usecase/nexcom/")
public class ConfirmSLAOfferWS4 {
