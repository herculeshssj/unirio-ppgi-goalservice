...
@XmlRootElement(name = "confirmSLAOfferWS2Response", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "confirmSLAOfferWS2Response", namespace = "http://ip-super.org/usecase/nexcom/")
public class ConfirmSLAOfferWS2Response {
