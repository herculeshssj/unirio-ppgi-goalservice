...
@XmlRootElement(name = "confirmSLAOfferWS6Response", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "confirmSLAOfferWS6Response", namespace = "http://ip-super.org/usecase/nexcom/")
public class ConfirmSLAOfferWS6Response {
