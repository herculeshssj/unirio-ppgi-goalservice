...
@XmlRootElement(name = "confirmSLAOfferWS1Response", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "confirmSLAOfferWS1Response", namespace = "http://ip-super.org/usecase/nexcom/")
public class ConfirmSLAOfferWS1Response {
