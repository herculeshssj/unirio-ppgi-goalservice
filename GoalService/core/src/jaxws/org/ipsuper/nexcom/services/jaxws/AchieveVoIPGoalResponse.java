...
@XmlRootElement(name = "achieveVoIPGoalResponse", namespace = "http://ip-super.org/usecase/nexcom/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "achieveVoIPGoalResponse", namespace = "http://ip-super.org/usecase/nexcom/")
public class AchieveVoIPGoalResponse {
