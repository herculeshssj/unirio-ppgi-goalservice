...
public class YSimulator {
    ...
    private void startPoller() {
        ...
        _timer.scheduleAtFixedRate(poller, _props.getInterval() * 10, _props.getInterval());
    }
    ...
    protected Set<WorkItemRecord> getAllocated(String pid)
            throws IOException, ResourceGatewayException {
    	Set<WorkItemRecord> wir = _wqAdapter.getQueuedWorkItems(pid, WorkQueue.ALLOCATED, _handle); 
    	return wir;
    }
